...
//    static JLabel infectedDisplay, deathDisplay, healthyDisplay, criticalDisplay, aliveDisplay, recoveredDisplay;
    ...
    // Переменные для отслеживания добавления нового Boid и позиции мыши
...
//                addedNewBoid = false;
//            }
                // Перерисовка панели для обновления дисплея
            this.repaint();
                // Ожидание короткого промежутка времени для контроля скорости симуляции
            try {
                Thread.sleep(10);
